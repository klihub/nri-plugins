...
used to make the preference for eligible containers a required one. If any
of the exclusively allocated CPUs for such a container are not isolated,
the policy will fail the creation of the container with an error.
