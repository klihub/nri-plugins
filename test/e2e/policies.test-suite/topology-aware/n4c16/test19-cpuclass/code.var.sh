...
cpu0=0
assert-cpu-frequency "reserved pool" $cpu0 reserved
...
assert-cpu-association ${pod}c0 $cpu0 "CLOS 0"
cpu1=$(cpuids-of $pod ${pod}c1)
assert-cpu-association ${pod}c1 $cpu1 "CLOS 0"
cpu2=$(cpuids-of $pod ${pod}c2)
assert-cpu-association ${pod}c2 $cpu2 "CLOS 0"
cpu3=$(cpuids-of $pod ${pod}c3)
assert-cpu-association ${pod}c3 $cpu3 "CLOS 0"
...
assert-cpu-association ${pod}c0 $cpu0 "CLOS 3"
assert-cpu-association ${pod}c1 $cpu1 "CLOS 3"
assert-cpu-association ${pod}c2 $cpu2 "CLOS 3"
assert-cpu-association ${pod}c3 $cpu3 "CLOS 3"
...
cpu0=$(cpuids-of $pod ${pod}c0)
assert-cpu-frequency ${pod}c0 $cpu0 class1
cpu1=$(cpuids-of $pod ${pod}c1)
assert-cpu-frequency ${pod}c1 $cpu1 class2
cpus2=$(cpuids-of $pod ${pod}c2)
assert-cpu-association ${pod}c2 $cpus2 "CLOS 0"
cpus3=$(cpuids-of $pod ${pod}c3)
assert-cpu-association ${pod}c3 $cpus3 "CLOS 0"
...
DEFAULT_EXCLUSIVE_CPUCLASS="non-existent"
