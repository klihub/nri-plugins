...
helm-terminate
nri_resource_policy_cfg=${TEST_DIR}/balloons-maxballoons.cfg helm-launch balloons
...
helm-terminate
( nri_resource_policy_cfg=${TEST_DIR}/balloons-maxballoons-impossible.cfg launch_timeout=5s helm-launch balloons ) && {
