...
helm-terminate
nri_resource_policy_cfg=$TEST_DIR/initial-balloons-config.cfg helm-launch balloons
...
cleanup
nri_resource_policy_config=$TEST_DIR/initial-balloons-config.cfg helm-launch balloons
