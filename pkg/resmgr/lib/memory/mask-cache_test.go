...
func TestMaskCache(t *testing.T) {
	...
	require.Equal(t, emptyNodeMask, m.NodesByTypes(TypeMaskHBM), "HBM nodes")
	require.Equal(t, dramAndPmemNodes, m.NodesByTypes(TypeMaskDRAM|TypeMaskPMEM), "DRAM&PMEM nodes")
	require.Equal(t, emptyNodeMask, m.NodesByTypes(TypeMaskDRAM|TypeMaskHBM), "DRAM&HBM nodes")
	require.Equal(t, emptyNodeMask, m.NodesByTypes(TypeMaskPMEM|TypeMaskHBM), "PMEM&HBM nodes")
	require.Equal(t, emptyNodeMask, m.NodesByTypes(TypeMaskAll), "DRAM&PMEM&HBM nodes")
}
