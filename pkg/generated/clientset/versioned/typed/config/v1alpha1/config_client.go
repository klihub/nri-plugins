...
type ConfigV1alpha1Interface interface {
	...
	BalloonsConfigsGetter
	TemplateConfigsGetter
	TopologyAwareConfigsGetter
}
...
func (c *ConfigV1alpha1Client) BalloonsConfigs(namespace string) BalloonsConfigInterface {
	return newBalloonsConfigs(c, namespace)
}

func (c *ConfigV1alpha1Client) TemplateConfigs(namespace string) TemplateConfigInterface {
	return newTemplateConfigs(c, namespace)
}

func (c *ConfigV1alpha1Client) TopologyAwareConfigs(namespace string) TopologyAwareConfigInterface {
	return newTopologyAwareConfigs(c, namespace)
}
