...
// TemplateConfigsGetter has a method to return a TemplateConfigInterface.
...
type TemplateConfigInterface interface {
	...
	UpdateStatus(ctx context.Context, templateConfig *v1alpha1.TemplateConfig, opts v1.UpdateOptions) (*v1alpha1.TemplateConfig, error)
...
// templateConfigs implements TemplateConfigInterface
type templateConfigs struct {
	client rest.Interface
	ns     string
}

// newTemplateConfigs returns a TemplateConfigs
func newTemplateConfigs(c *ConfigV1alpha1Client, namespace string) *templateConfigs {
...
func (c *templateConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TemplateConfigList, err error) {
	...
	result = &v1alpha1.TemplateConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("templateconfigs").
...
func (c *templateConfigs) UpdateStatus(ctx context.Context, templateConfig *v1alpha1.TemplateConfig, opts v1.UpdateOptions) (result *v1alpha1.TemplateConfig, err error) {
	result = &v1alpha1.TemplateConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("templateconfigs").
